...
% Custom title without extra packages
\makeatletter
...
This document defines the Concord Rules for the game of Go, a rule set aiming for three goals:
...
\subsection*{Comparison To Japanese/Korean Rules (with Concord Territory Counting)}
    \begin{itemize}
