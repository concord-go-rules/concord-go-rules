...
\begin{itemize}
    ...
    \item \textbf{You can use both territory and area counting methods.} Both methods always give the same game result. (Similar to AGA rules. Unlike Chinese and Japanese/Korean rules.)
...
\subsection*{Differences from Japanese/Korean Rules}
    ...
    This gives the opponent one point, but since all games typically end with two passes, this does not change the result.
    ...
    Rare example where that matters: ..., B pass, W threat, B answer, W pass, B pass, \bf{W pass}.
    \end{itemize}
