...
These differences sometimes confuse players who travel between regions, complicate international competition, and cause disputes in tournaments.
Players in international tournaments often struggle with unfamiliar counting methods and sometimes have trouble judging seki scoring.
For example, see \href{https://senseis.xmp.net/?RuleDisputesInvolvingGoSeigen}{rule disputes involving Go Seigen}.

The Concord Rules explore how these traditions can work together.
...
\item Clear rules that Go engines and AI programs can understand
\item Only two small changes—pass stones and a last pass rule
\item Evolution of traditional rule systems
\end{itemize}

Concord Rules are an optimal design to achieve these goals while keeping the spirit of Go.
Concord Rules offer a way toward common standards in the global Go community.
