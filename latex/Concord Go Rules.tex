...
% Title
\begin{center} {\LARGE\bfseries Concord Rules for the Game of Go} \vskip 3em \end{center}
...
\begin{itemize}
    ...
    \item \textbf{Both territory and area counting work.} Both methods always give the same game result. (Similar to AGA rules, unlike Chinese and Japanese/Korean rules.)
...
International players sometimes struggle with unfamiliar counting methods and have trouble with seki scoring.
...
\item Optimal evolution of traditional rule systems to achieve stated goals.
\end{itemize}
