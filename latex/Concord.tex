...
% Title
\begin{center} {\Large\bfseries Concord Go Rules Quick Start Guide} \vskip 1.5em \end{center}
\vskip 2em%
\subsection*{If You Know Japanese/Korean Rules}
    \begin{itemize}
...
\vskip 2em%
\subsection*{If You Know Chinese Rules}
    \begin{itemize}
...
\vskip 2em%
\subsection*{If You Know AGA Rules}
    \begin{itemize}
    ...
    Black has no such privilige. This makes the first pass half as valuable as a dame point (neutral point).
    \end{itemize}
